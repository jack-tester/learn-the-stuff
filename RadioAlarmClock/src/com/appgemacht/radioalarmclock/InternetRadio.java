...
public class InternetRadio {
    ...
    public void start(final Context context, final boolean increaseVolume) {
        ...
        Log.v("Radio", "Starting radio from stream " + streamURL + " volume "
                + volume);
        ...
        try {
            ...
            mediaPlayer.setOnPreparedListener(new OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    ...
                    mp.setVolume(1, 1); // MediaPlayer-Lautstärke maximal,
                                        // Gesamtlautstärke ergibt sich durch
                                        // AudioManager
                    if (increaseVolume) {
    ...
    private void scheduleVolumeIncrease(final AudioManager am,
    ...
    public void playDefaultAlarm(final Context context) {
        ...
        if (ringtone != null) {
            ringtone.setStreamType(AudioManager.STREAM_ALARM); // mit
                                                               // Alarm-Lautstärke
            ringtone.play();
        } else
