...
public class Alarm {
    ...
    public String toString() {
        return weekdayAsShortString(dayOfWeek) + " "
                + timeAsString(hours, minutes);
    }

    // Hilfsfunktionen

    // sortierte Liste von Wochentagen, beginnend mit dem ersten Tag der Woche
    // (Mo für Deutschland, So für USA etc)
    ...
    // Spezialfall: nur Wochentag (ausgeschrieben)
    ...
    @SuppressLint("SimpleDateFormat")
    // Spezialfall: nur Wochentag (kurz)
